...
class _EditProfileDialogState extends State<EditProfileDialog> {
  ...
  late String _selectedMaturityRating;
  ...
  void initState() {
    ...
    _isKidsProfile = widget.profile.isKidsProfile;
    _selectedMaturityRating = widget.profile.maturityRating;
  ...
  Future<void> _handleUpdateProfile() async {
    ...
    final success = await widget.controller.updateProfile(updatedProfile);
    ...
    if (success && mounted) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Profile "${_nameController.text.trim()}" updated successfully'),
